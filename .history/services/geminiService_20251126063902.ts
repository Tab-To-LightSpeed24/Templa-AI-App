...
export const generateSectionContent = async (
    ...
    if (type === DocumentType.PPTX) {
        ...
        3. **NO TITLE REPETITION**: Do NOT output the text "${sectionTitle}" at the start. Start directly with the content.
...
export const chatWithProjectAI = async (messages: any[], project: any, id?: string): Promise<any> => {
